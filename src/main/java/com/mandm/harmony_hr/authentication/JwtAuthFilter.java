package com.mandm.harmony_hr.authentication;
...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    public JwtAuthFilter(JwtUtils jwtUtils, SecurityUsersDetailsService securityUsersDetailsService) {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        try {
            ...
            if (jwt != null) {
                ...
                UserDetails userDetails = securityUsersDetailsService.loadUserByUsername(username);
